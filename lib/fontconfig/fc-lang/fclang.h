...
/* total size: 1109 unique leaves: 725 */

#define LEAF0       (245 * sizeof (FcLangCharSet))
...
static const struct {
    FcLangCharSet  langCharSets[245];
    FcCharLeaf     leaves[725];
    uintptr_t      leaf_offsets[780];
    FcChar16       numbers[780];
    FcChar8        langIndices[245];
    FcChar8        langIndicesInv[245];
} fcLangData = {
{
    ...
    { "rm",  { FC_REF_CONSTANT, 1, OFF(168,348), NUM(168,348) } }, /* 168 */
    { "rn",  { FC_REF_CONSTANT, 1, OFF(169,87), NUM(169,87) } }, /* 169 */
    { "ro",  { FC_REF_CONSTANT, 3, OFF(170,349), NUM(170,349) } }, /* 170 */
    { "ru",  { FC_REF_CONSTANT, 1, OFF(171,280), NUM(171,280) } }, /* 171 */
    { "rw",  { FC_REF_CONSTANT, 1, OFF(172,87), NUM(172,87) } }, /* 172 */
    { "sa",  { FC_REF_CONSTANT, 1, OFF(173,30), NUM(173,30) } }, /* 173 */
    { "sah",  { FC_REF_CONSTANT, 1, OFF(174,352), NUM(174,352) } }, /* 174 */
    { "sat",  { FC_REF_CONSTANT, 1, OFF(175,353), NUM(175,353) } }, /* 175 */
    { "sc",  { FC_REF_CONSTANT, 1, OFF(176,354), NUM(176,354) } }, /* 176 */
    { "sco",  { FC_REF_CONSTANT, 3, OFF(177,355), NUM(177,355) } }, /* 177 */
    { "sd",  { FC_REF_CONSTANT, 1, OFF(178,358), NUM(178,358) } }, /* 178 */
    { "se",  { FC_REF_CONSTANT, 2, OFF(179,359), NUM(179,359) } }, /* 179 */
    { "sel",  { FC_REF_CONSTANT, 1, OFF(180,280), NUM(180,280) } }, /* 180 */
    { "sg",  { FC_REF_CONSTANT, 1, OFF(181,361), NUM(181,361) } }, /* 181 */
    { "sh",  { FC_REF_CONSTANT, 3, OFF(182,362), NUM(182,362) } }, /* 182 */
    { "shs",  { FC_REF_CONSTANT, 2, OFF(183,365), NUM(183,365) } }, /* 183 */
    { "si",  { FC_REF_CONSTANT, 1, OFF(184,367), NUM(184,367) } }, /* 184 */
    { "sid",  { FC_REF_CONSTANT, 2, OFF(185,368), NUM(185,368) } }, /* 185 */
    { "sk",  { FC_REF_CONSTANT, 2, OFF(186,370), NUM(186,370) } }, /* 186 */
    { "sl",  { FC_REF_CONSTANT, 2, OFF(187,42), NUM(187,42) } }, /* 187 */
    { "sm",  { FC_REF_CONSTANT, 2, OFF(188,372), NUM(188,372) } }, /* 188 */
    { "sma",  { FC_REF_CONSTANT, 1, OFF(189,374), NUM(189,374) } }, /* 189 */
    { "smj",  { FC_REF_CONSTANT, 1, OFF(190,375), NUM(190,375) } }, /* 190 */
    { "smn",  { FC_REF_CONSTANT, 2, OFF(191,376), NUM(191,376) } }, /* 191 */
    { "sms",  { FC_REF_CONSTANT, 3, OFF(192,378), NUM(192,378) } }, /* 192 */
    { "sn",  { FC_REF_CONSTANT, 1, OFF(193,87), NUM(193,87) } }, /* 193 */
    { "so",  { FC_REF_CONSTANT, 1, OFF(194,87), NUM(194,87) } }, /* 194 */
    { "sq",  { FC_REF_CONSTANT, 1, OFF(195,381), NUM(195,381) } }, /* 195 */
    { "sr",  { FC_REF_CONSTANT, 1, OFF(196,382), NUM(196,382) } }, /* 196 */
    ...
    { "sv",  { FC_REF_CONSTANT, 1, OFF(200,383), NUM(200,383) } }, /* 200 */
    { "sw",  { FC_REF_CONSTANT, 1, OFF(201,87), NUM(201,87) } }, /* 201 */
    { "syr",  { FC_REF_CONSTANT, 1, OFF(202,384), NUM(202,384) } }, /* 202 */
    { "ta",  { FC_REF_CONSTANT, 1, OFF(203,385), NUM(203,385) } }, /* 203 */
    { "te",  { FC_REF_CONSTANT, 1, OFF(204,386), NUM(204,386) } }, /* 204 */
    { "tg",  { FC_REF_CONSTANT, 1, OFF(205,387), NUM(205,387) } }, /* 205 */
    { "th",  { FC_REF_CONSTANT, 1, OFF(206,388), NUM(206,388) } }, /* 206 */
    { "ti-er",  { FC_REF_CONSTANT, 2, OFF(207,45), NUM(207,45) } }, /* 207 */
    { "ti-et",  { FC_REF_CONSTANT, 2, OFF(208,368), NUM(208,368) } }, /* 208 */
    { "tig",  { FC_REF_CONSTANT, 2, OFF(209,389), NUM(209,389) } }, /* 209 */
    { "tk",  { FC_REF_CONSTANT, 2, OFF(210,391), NUM(210,391) } }, /* 210 */
    { "tl",  { FC_REF_CONSTANT, 1, OFF(211,86), NUM(211,86) } }, /* 211 */
    { "tn",  { FC_REF_CONSTANT, 2, OFF(212,327), NUM(212,327) } }, /* 212 */
    { "to",  { FC_REF_CONSTANT, 2, OFF(213,372), NUM(213,372) } }, /* 213 */
    { "tr",  { FC_REF_CONSTANT, 2, OFF(214,393), NUM(214,393) } }, /* 214 */
    { "ts",  { FC_REF_CONSTANT, 1, OFF(215,87), NUM(215,87) } }, /* 215 */
    { "tt",  { FC_REF_CONSTANT, 1, OFF(216,395), NUM(216,395) } }, /* 216 */
    { "tw",  { FC_REF_CONSTANT, 5, OFF(217,4), NUM(217,4) } }, /* 217 */
    { "ty",  { FC_REF_CONSTANT, 3, OFF(218,396), NUM(218,396) } }, /* 218 */
    { "tyv",  { FC_REF_CONSTANT, 1, OFF(219,285), NUM(219,285) } }, /* 219 */
    { "ug",  { FC_REF_CONSTANT, 1, OFF(220,399), NUM(220,399) } }, /* 220 */
    { "uk",  { FC_REF_CONSTANT, 1, OFF(221,400), NUM(221,400) } }, /* 221 */
    { "und-zmth",  { FC_REF_CONSTANT, 12, OFF(222,401), NUM(222,401) } }, /* 222 */
    { "und-zsye",  { FC_REF_CONSTANT, 12, OFF(223,413), NUM(223,413) } }, /* 223 */
    { "ur",  { FC_REF_CONSTANT, 1, OFF(224,288), NUM(224,288) } }, /* 224 */
    { "uz",  { FC_REF_CONSTANT, 1, OFF(225,87), NUM(225,87) } }, /* 225 */
    { "ve",  { FC_REF_CONSTANT, 2, OFF(226,425), NUM(226,425) } }, /* 226 */
    { "vi",  { FC_REF_CONSTANT, 4, OFF(227,427), NUM(227,427) } }, /* 227 */
    { "vo",  { FC_REF_CONSTANT, 1, OFF(228,431), NUM(228,431) } }, /* 228 */
    { "vot",  { FC_REF_CONSTANT, 2, OFF(229,432), NUM(229,432) } }, /* 229 */
    { "wa",  { FC_REF_CONSTANT, 1, OFF(230,434), NUM(230,434) } }, /* 230 */
    { "wal",  { FC_REF_CONSTANT, 2, OFF(231,368), NUM(231,368) } }, /* 231 */
    { "wen",  { FC_REF_CONSTANT, 2, OFF(232,435), NUM(232,435) } }, /* 232 */
    { "wo",  { FC_REF_CONSTANT, 2, OFF(233,437), NUM(233,437) } }, /* 233 */
    { "xh",  { FC_REF_CONSTANT, 1, OFF(234,87), NUM(234,87) } }, /* 234 */
    { "yap",  { FC_REF_CONSTANT, 1, OFF(235,439), NUM(235,439) } }, /* 235 */
    { "yi",  { FC_REF_CONSTANT, 1, OFF(236,108), NUM(236,108) } }, /* 236 */
    { "yo",  { FC_REF_CONSTANT, 4, OFF(237,440), NUM(237,440) } }, /* 237 */
    { "za",  { FC_REF_CONSTANT, 1, OFF(238,87), NUM(238,87) } }, /* 238 */
    { "zh-cn",  { FC_REF_CONSTANT, 82, OFF(239,444), NUM(239,444) } }, /* 239 */
    { "zh-hk",  { FC_REF_CONSTANT, 171, OFF(240,526), NUM(240,526) } }, /* 240 */
    { "zh-mo",  { FC_REF_CONSTANT, 171, OFF(241,526), NUM(241,526) } }, /* 241 */
    { "zh-sg",  { FC_REF_CONSTANT, 82, OFF(242,444), NUM(242,444) } }, /* 242 */
    { "zh-tw",  { FC_REF_CONSTANT, 83, OFF(243,697), NUM(243,697) } }, /* 243 */
    { "zu",  { FC_REF_CONSTANT, 1, OFF(244,87), NUM(244,87) } }, /* 244 */
},
{
    { { /* 0 */
...
static const FcChar32 fcLangCountrySets[][NUM_LANG_SET_MAP] = {
    ...
    { 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00180000, }, /* und */
